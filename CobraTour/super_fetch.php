...
if (isset($_SESSION['id'])) { // Use 'id' to match the login session variable
    ...
    $sql = "SELECT username, password FROM super WHERE id = ?"; 
        ...
        <section class="account-section">
            <div class="account-container">
                <span class="span-account">
                    ...
                    <label class="account-label">Control Admin</label>
                </span>
        ...
        <section>
                <div class="account-details">
                    <span class="account-span">
                        ...
                        <form id="newUsername" class="newuser-display" style="display: none;" action="super-acc-edit.php" method="POST">
                ...
                <div class="account-details">
                    <span class="account-span">
                        ...
                        <form id="newPassword" class="newpass-display" style="display: none;" action="super-acc-edit.php" method="POST">
