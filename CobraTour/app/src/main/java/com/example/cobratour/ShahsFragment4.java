...
public class ShahsFragment4 extends Fragment {

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        // Inflate the ph_1.xml layout
        View view = inflater.inflate(R.layout.shahs_4, container, false);
        ...
        secondPageButton.setOnClickListener(v -> replaceFragment(new ShahsFragment2()));
