...
public class PhFragment5 extends Fragment {

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        // Inflate the ph_1.xml layout
        View view = inflater.inflate(R.layout.ph_5, container, false);

        // Setup button listeners for navigation
        Button fifthPageButton = view.findViewById(R.id.first_page_button);
        fifthPageButton.setOnClickListener(v -> replaceFragment(new PhFragment1()));
