...
public class PhFragment4 extends Fragment {

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        // Inflate the ph_1.xml layout
        View view = inflater.inflate(R.layout.ph_4, container, false);

        // Setup button listeners for navigation
        Button secondPageButton = view.findViewById(R.id.first_page_button);
        secondPageButton.setOnClickListener(v -> replaceFragment(new PhFragment1()));

        Button thirdPageButton = view.findViewById(R.id.second_page_button);
        thirdPageButton.setOnClickListener(v -> replaceFragment(new PhFragment2()));

        Button fourthPageButton = view.findViewById(R.id.third_page_button);
        fourthPageButton.setOnClickListener(v -> replaceFragment(new PhFragment3()));
